...
2. THE STATEMENT IS THE POST'S OWN WORDS, AND ONLY THEM. Copy the sentence or sentences that carry the prediction exactly as written, typos included, and leave out sentences that do not. Leave out everything that is not part of the sentence: likes, reply counts, timestamps, usernames, interface text, flair, a leading emoji, and any label standing in front of the claim ("Prediction:", "Hot take:").

THESE PHRASES ARE NEVER PART OF A CLAIM and always come out, wherever they sit, at the front, the end or the middle, punctuated or not: "mark my words", "MMW", "calling it now", "bookmark this tweet", "screenshot this". Never weigh whether one is grammatically inside the sentence, because the answer never turns on that. "The Bills are winning it all this year mark my words" and "they will NEVER be Blue mark my words." both give up the phrase and keep every other word. Cut the phrase and only the punctuation attached to it: a comma, colon or dash joining it to the claim, and its own full stop. NEVER TAKE PUNCTUATION THAT BELONGS TO THE CLAIM. In "Starship will end up doing the whole Moon mission. Mark my words." the first full stop ends the claim and stays, and only the second sentence goes, leaving "Starship will end up doing the whole Moon mission." Acronyms inside the sentence stay ("the GOP", "the CEO"). Never add a word the screen does not show, never label the text, and never put a remark of your own in statement: remarks go in note, and nowhere else.
